...
<table border="1">
    ...
    <?php foreach($pos as $p){
        ...
        <tr>
            ...
            <td><a href="?page=delete&action=post&post_id=<?php echo $p['post_id']?>">Obrisi</a></td>
            <td><a href="?page=admin&action=post_approved&post_id=<?php echo $p['post_id']?>">Odobri</a></td>
        </tr>
    <?php } ?>
    </tbody>
</table>